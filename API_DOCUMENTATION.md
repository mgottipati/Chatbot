# CS571 F25 AI API Documentation
...
`POST` `https://cs571api.cs.wisc.edu/rest/f25/hw11/completions`
...
`POST` `https://cs571api.cs.wisc.edu/rest/f25/hw11/completions-stream`
